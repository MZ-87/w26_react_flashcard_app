...
export default function Banner() {
    return (
        <div className={style.banner}>
            ...
            <div className={style.card_btn}><Link to="/cards" style={{ textDecoration: 'none' }}>Открыть карточки</Link></div>
            <div className={style.train_btn}><Link to="/training" style={{ textDecoration: 'none' }}>Перейти к тренировке</Link></div>
        </div>
    )
}
